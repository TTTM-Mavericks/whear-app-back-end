...
public interface RuleMatchingClothesRepository extends JpaRepository<RuleMatchingClothes, Integer> {
    @Modifying
    @Transactional
    @Query(value = "insert into rule_matching_clothes (style_type, body_shape_type, top_inside, top_inside_color, top_outside, top_outside_color, " +
    ...
    void createNewRuleMatchingClothes(String style_type, String body_shape_type, String top_inside, String top_inside_color, String top_outside, String top_outside_color,
