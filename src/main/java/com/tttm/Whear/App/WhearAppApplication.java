...
public class WhearAppApplication {
  ...
  @Bean
  public CommandLineRunner createRuleMatchingClothes(
      RuleMatchingClothesRepository ruleMatchingClothesRepository, StyleRepository styleRepository,
    ...
    return arg -> {
      ...
      if (ruleMatchingClothesRepository.findAll().size() == 0) {
        ...
        RuleMatchingClothes rule5 = RuleMatchingClothes.builder()
            .styleID(styleRepository.getStyleByStyleName("CYBERPUNK").getStyleID())
            .bodyShapeID(
                bodyShapeRepository.getBodyShapeByBodyShapeName("INVERTED_TRIANGLE_SHAPE")
                    .getBodyShapeID())
            .topInside("CROP_TOP")
        ...
        RuleMatchingClothes rule6 = RuleMatchingClothes.builder()
            .styleID(styleRepository.getStyleByStyleName("CYBERPUNK").getStyleID())
            .bodyShapeID(
                bodyShapeRepository.getBodyShapeByBodyShapeName("LEAN_OR_SLIM_SHAPE")
                    .getBodyShapeID())
            .topInside("T_SHIRT")
  ...
  @Bean
  public CommandLineRunner adminAccount(UserRepository userRepository) {
    return arg -> {
